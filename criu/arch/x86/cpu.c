...
static uint32_t x86_ins_capability_mask[NCAPINTS] = {
	...
	[CPUID_8000_0001_EDX] =				       // clang-format
	...
	[CPUID_8000_0001_ECX] =					    // clang-format
	...
	[CPUID_8000_0008_EBX] = // clang-format
	__ins_bit(CPUID_8000_0008_EBX, X86_FEATURE_CLZERO),

	[CPUID_7_0_EDX] =				      // clang-format
